...
table_name_1 = 'KL'  # name of the table to be created
new_column_1 = 'ReferenceName' # name of the column_1
new_column_2 = 'MappingResult' # name of the column_2
data_set = 'processed_KL_log' # data source
